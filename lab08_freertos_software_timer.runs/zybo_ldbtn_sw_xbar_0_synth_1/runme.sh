...
HD_PWD='C:/Zynq_Book/lab08_freertos_software_timer/lab08_freertos_software_timer.runs/zybo_ldbtn_sw_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_ldbtn_sw_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_ldbtn_sw_xbar_0.tcl
