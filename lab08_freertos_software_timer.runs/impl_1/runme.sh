...
HD_PWD='C:/Zynq_Book/lab08_freertos_software_timer/lab08_freertos_software_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_ldbtn_sw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_ldbtn_sw_wrapper.tcl -notrace
